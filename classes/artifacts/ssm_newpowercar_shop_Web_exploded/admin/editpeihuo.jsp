			...
			<form action="peihuo/updatePeihuo.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 40%">
					...
					<div class="formRow">
						<label>汽贸中心名称</label>
						<div class="formRight">
							<input type="text" name="peihuoname" class="mws-textinput" id="peihuoname" value="${peihuo.peihuoname}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						<label>备注</label>
						<div class="formRight">
							<input type="text" name="memo" class="mws-textinput" id="memo" value="${peihuo.memo}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formSubmit">
						<input type="hidden" name="peihuoid" id="peihuoid" value="${peihuo.peihuoid}" /> <input type="submit" id="sub"
