		...
		<div class="wrapper">
			<div class="widget">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="sTable">
					...
					<thead>
						<tr>
							<td class="center">汽贸中心名称</td>
							<td class="center">城市</td>
							<td class="center">地址</td>
							<td class="center">联系手机</td>
							<td class="center">备注</td>
						</tr>
					</thead>
					<c:forEach items="${peihuoList}" var="peihuo">
						<tr align="center">
							<td class="center">${peihuo.peihuoname}</td>
							<td class="center">${peihuo.cityname}</td>
							<td class="center">${peihuo.address}</td>
							<td class="center">${peihuo.contact}</td>
							<td class="center">${peihuo.memo}</td>
						</tr>
					</c:forEach>
				</table>
				<div class="dataTables_wrapper">
					<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix">
						<form action="peihuo/queryPeihuoByCond.action" name="myform" method="post">
							<label>查询条件: <select name="cond" style="width: 100px">
									<option value="peihuoname">按汽贸中心名称查询</option>
									<option value="cityid">按城市查询</option>
									<option value="address">按地址查询</option>
									<option value="contact">按联系手机查询</option>
