...
$("#newcarname").blur(
		function() {
			$("#newcarname_msg").empty();
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#newcarname").after("<span id='newcarname_msg' style='color: red'>新能源汽车名称不能为空</span>");
			}
	});
...
$("#cateid").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#cateid").after("<span id='cateid_msg' style='color: red'>新能源汽车类型不能为空</span>");
			}
	});
...
$("#contents").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#contents").after("<span id='contents_msg' style='color: red'>新能源汽车介绍不能为空</span>");
			}
	});
