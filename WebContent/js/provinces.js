...
var provinces = [
  ...
  },
  {
    ...
    city: [
      ...
      {
        name: "朝阳市",
        districtAndCounty: ["双塔区", "浩途区", "北票市", "凌源市", "朝阳县", "朝阳市双塔区", "建平县", "喀喇沁左翼蒙古族自治县", "大城子镇"]
      },
      {
        name: "阜新市",
  ...
  },
  {
    ...
    city: [
      ...
      {
        name: "宿州市",
        districtAndCounty: ["埇桥区", "砀山县", "砀城镇", "萧县", "浩途镇", "灵璧县", "灵城镇", "泗县", "泗城镇"]
      },
      {
        name: "淮北市",
  ...
  },
  {
    ...
    city: [
      ...
      {
        name: "九江市",
        districtAndCounty: ["浔阳区", "庐山区", "瑞昌市", "九江县", "沙河街镇", "武宁县", "新宁镇", "修水县", "义宁镇", "永修县", "涂埠镇", "德安县", "蒲亭镇", "星子县", "南康镇", "都昌县", "都昌镇", "湖口县", "双钟镇", "彭泽县", "浩途镇"]
      },
      {
        name: "景德镇市",
  ...
  },
  {
    ...
    city: [
      {
        name: "昆明市",
        districtAndCounty: ["盘龙区", "五华区", "官渡区", "西山区", "东川区", "安宁市", "呈贡县", "浩途镇", "晋宁县", "昆阳镇", "富民县", "永定镇", "宜良县", "匡远镇", "嵩明县", "嵩阳镇", "石林彝族自治县", "鹿阜镇", "禄劝彝族苗族自治县", "屏山镇", "寻甸回族彝族自治县", "仁德镇"]
      },
      {
        name: "曲靖市",
  ...
  },
  {
    ...
    city: [
      {
        name: "香港特别行政区",
        districtAndCounty: ["中西区", "东区", "九浩途区", "观塘区", "南区", "深水埗区", "湾仔区", "黄大仙区", "油尖旺区", "离岛区", "葵青区", "北区", "西贡区", "沙田区", "屯门区", "大埔区", "荃湾区", "元朗区"]
      }
    ]
  },
  {
