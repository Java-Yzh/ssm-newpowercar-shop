...
<body>
	...
	<div id="rightSide">
		...
		<div class="line"></div>
		<div class="wrapper">
			<form action="newcar/addNewcar.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 80%">
					...
					<div class="formRow">
						<label>新能源汽车名称</label>
						<div class="formRight">
							<input type="text" name="newcarname" class="mws-textinput" id="newcarname" placeholder="请输入新能源汽车名称" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						...
						<div class="formRight">
							...
							<textarea cols="80" name="contents" id="contents" rows="10" placeholder="请输入新能源汽车介绍"> </textarea>
